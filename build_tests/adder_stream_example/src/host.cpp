...
int main(int argc, char* argv[]) {
    ...
    cl::Kernel krnl_adder_add(program,"adder");
    ...
    int narg=0;
    krnl_adder_add.setArg(narg++,buffer_a);
    krnl_adder_add.setArg(narg++,buffer_result);
    krnl_adder_add.setArg(narg++, 1);
    krnl_adder_add.setArg(narg++,DATA_SIZE);
