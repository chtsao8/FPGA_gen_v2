#ifndef HALIDE_____bin___cpu___conv_3_3_h
#define HALIDE_____bin___cpu___conv_3_3_h
#include <stdint.h>
...
int conv_3_3(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int conv_3_3_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *conv_3_3_metadata() HALIDE_FUNCTION_ATTRS;
