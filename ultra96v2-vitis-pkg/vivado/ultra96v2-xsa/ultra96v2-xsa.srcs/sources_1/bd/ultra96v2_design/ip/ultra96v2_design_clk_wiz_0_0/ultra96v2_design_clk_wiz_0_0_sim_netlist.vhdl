...
--               /home/chtsao/aha/FPGA_gen_v2/ultra96v2-vitis-pkg/vivado/ultra96v2-xsa/ultra96v2-xsa.srcs/sources_1/bd/ultra96v2_design/ip/ultra96v2_design_clk_wiz_0_0/ultra96v2_design_clk_wiz_0_0_sim_netlist.vhdl
...
entity ultra96v2_design_clk_wiz_0_0_ultra96v2_design_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of ultra96v2_design_clk_wiz_0_0_ultra96v2_design_clk_wiz_0_0_clk_wiz : entity is "ultra96v2_design_clk_wiz_0_0_clk_wiz";
end ultra96v2_design_clk_wiz_0_0_ultra96v2_design_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of ultra96v2_design_clk_wiz_0_0_ultra96v2_design_clk_wiz_0_0_clk_wiz is
  signal clk_in1_ultra96v2_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_ultra96v2_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_ultra96v2_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_ultra96v2_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out4_ultra96v2_design_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_ultra96v2_design_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_ultra96v2_design_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_ultra96v2_design_clk_wiz_0_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_ultra96v2_design_clk_wiz_0_0,
      O => clk_out3
    );
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out4_ultra96v2_design_clk_wiz_0_0,
      O => clk_out4
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_ultra96v2_design_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_ultra96v2_design_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_ultra96v2_design_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_ultra96v2_design_clk_wiz_0_0,
      CLKOUT2B => NLW_mmcme4_adv_inst_CLKOUT2B_UNCONNECTED,
      CLKOUT3 => clk_out4_ultra96v2_design_clk_wiz_0_0,
...
entity ultra96v2_design_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of ultra96v2_design_clk_wiz_0_0 : entity is true;
end ultra96v2_design_clk_wiz_0_0;

architecture STRUCTURE of ultra96v2_design_clk_wiz_0_0 is
begin
inst: entity work.ultra96v2_design_clk_wiz_0_0_ultra96v2_design_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
